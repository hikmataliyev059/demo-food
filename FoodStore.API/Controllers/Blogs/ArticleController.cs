...
public class ArticleController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<ActionResult<ArticleGetDto>> CreateArticleAsync([FromForm] ArticleCreateDto articleCreateDto)
    {
    ...
    [HttpPut("{id}")]
    public async Task<ActionResult<ArticleGetDto>> UpdateArticleAsync(int id, [FromForm] ArticleUpdateDto articleUpdate)
    {
