...
public class ResetPasswordDtoValidator : AbstractValidator<ResetPasswordDto>
{
    public ResetPasswordDtoValidator()
    {
        ...
        RuleFor(x => x.Token).NotEmpty().NotNull().WithMessage(ValidationMessages.Required);

        RuleFor(x => x.Password).NotEmpty().NotNull().WithMessage(ValidationMessages.PasswordRequired)
